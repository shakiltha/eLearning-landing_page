  ...
  return (
    <div className="mt-3">
      ...
      <div className="md:flex">
        <section className="w-[350px] h-[250px] lg:w-[500px]  mx-auto border shadow-xl mt-4 p-2 xl:-mr-6 rounded-xl">
          <div>
        ...
        <section className="w-[350px] h-[250px] lg:w-[500px]  mx-auto border shadow-xl mt-4 p-2 rounded-xl">
          <div>
